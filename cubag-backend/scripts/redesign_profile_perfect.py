...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void _openDigitalIdDialog(StandingTier tier, String? expiry, int? daysLeft) {
    showDialog(
      context: context,
      ...
      builder: (ctx) => Dialog(
        ...
        child: _buildDigitalIdCard(ctx, tier, expiry, daysLeft),
      ),
    );
  }
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton.icon(
                                ...
                                onPressed: () => _openDigitalIdDialog(tier, expiry, daysLeft),
  ...
  Widget _buildDigitalIdCard(BuildContext dialogCtx, StandingTier tier, String? expiry, int? daysLeft) {
...
print("Updated profile_page.dart with showDialog for Digital ID, removed password management, and fixed all text wrapping")
