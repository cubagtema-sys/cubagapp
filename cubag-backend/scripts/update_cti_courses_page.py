...
FILE_PATH = "/Users/guyman-gh/Downloads/CUB-26/CUSTOMS/cubag_flutter/lib/pages/cti_courses_page.dart"
...
const _kDarkBrown = Color(0xFF1F110B);
const _kBrown = Color(0xFF381E13);
...
class _CtiCoursesPageState extends State<CtiCoursesPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _fetchCourses() async {
    ...
    // Fallback official catalog if offline
    if (mounted) {
      setState(() {
        _courses = [
          {
    ...
    showModalBottomSheet(
      ...
      builder: (sheetCtx) => StatefulBuilder(
        builder: (context, setSheetState) {
          ...
          final sheetBg = isDark ? const Color(0xFF181C28) : Colors.white;
          ...
          final borderCol = isDark ? const Color(0xFF262C3D) : const Color(0xFFE2E8F0);
          final innerBox = isDark ? const Color(0xFF10141E) : const Color(0xFFF8FAFC);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Automated push reminders notify you 7 days, 3 days & 1 day before start date.',
                    ...
                    if (paymentMethod == 'momo') ...[
                      Row(
                        children: ['MTN', 'Telecel', 'AT'].map((net) {
                          final isSel = network == net;
                          return Padding(
                            padding: const EdgeInsets.only(right: 6),
                            child: ChoiceChip(
                              label: Text(net, style: GoogleFonts.outfit(fontSize: 11, fontWeight: FontWeight.bold)),
                              selected: isSel,
                              selectedColor: _kOrange,
                              labelStyle: TextStyle(color: isSel ? Colors.white : textCol),
                              onSelected: (_) => setSheetState(() => network = net),
                            ),
                          );
                        }).toList(),
                      ),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        filled: true,
                        fillColor: innerBox,
                        labelText: paymentMethod == 'momo' ? '$network MoMo Number' : 'Card Holder Phone',
                        hintText: '024XXXXXXX',
                    ...
                    if (errorMsg != null) ...[
                      const SizedBox(height: 8),
                      Text(errorMsg!, style: GoogleFonts.inter(fontSize: 11, color: _kRed, fontWeight: FontWeight.bold)),
                    ],
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('You are successfully enrolled in:', style: GoogleFonts.inter(fontSize: 12.5)),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('🔔 Reminders: The CUBAG App will notify you when course date is near.', style: GoogleFonts.inter(fontSize: 11)),
                ],
              ),
            ),
          ],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _buildHeroStat('3 Available', Icons.grid_view_rounded, _kOrange),
                      const SizedBox(width: 8),
...
print("Updated cti_courses_page.dart successfully")
