...
FLUTTER_FILE = "/Users/guyman-gh/Downloads/CUB-26/CUSTOMS/cubag_flutter/lib/pages/admin_tickets_page.dart"
...
class _AdminTicketsPageState extends State<AdminTicketsPage> {
  ...
  Widget _buildMessageBubble({
    ...
    final bubbleBg = isAdmin
        ? (isDark ? const Color(0xFF281E15) : const Color(0xFFFFF7ED))
        : (isDark ? const Color(0xFF151926) : const Color(0xFFF1F5F9));
