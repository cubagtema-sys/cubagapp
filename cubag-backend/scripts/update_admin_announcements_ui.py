...
FLUTTER_FILE = "/Users/guyman-gh/Downloads/CUB-26/CUSTOMS/cubag_flutter/lib/pages/admin_announcements_page.dart"
          ...
          children: [
            ...
            AdminHeader(
              ...
              actions: [
                ...
                ElevatedButton.icon(
                  style: ElevatedButton.styleFrom(
                    backgroundColor: _tab == 'create' ? _kSlate : _kOrange,
                    foregroundColor: Colors.white,
  ...
  Widget _buildTabBtn(String label, String key, int? count, IconData icon) {
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSel ? _kOrange : (isDark ? const Color(0xFF242A3E) : const Color(0xFFF1F5F9)),
          borderRadius: BorderRadius.circular(10),
          boxShadow: isSel
            ...
            children: categories.map((c) {
              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: sel ? color.withAlpha(25) : (isDark ? const Color(0xFF1F2536) : const Color(0xFFF1F5F9)),
                    borderRadius: BorderRadius.circular(10),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildAnnouncementCard(
            ...
            isPreview: true,
            isDark: isDark,
            cardBg: isDark ? const Color(0xFF11141F) : const Color(0xFFF8FAFC),
            border: border,
            textPrimary: textPrimary,
            textMuted: textMuted,
          ),
...
print(f"Successfully wrote {len(CODE.splitlines())} lines to {FLUTTER_FILE}")
